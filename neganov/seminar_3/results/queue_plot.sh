...
gnuplot <<< "set term png size 1920,1080; \
             ...
             plot 'ticket_1.dat'           u 1:(column(2)/1000) title 'ticket'                     w linespoints ls 11, \
                  ...
                  'queue_no_deref_1.dat'   u 1:(column(2)/1000) title 'queue excl no deref line'   w linespoints ls 7, \
